...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-gold" data-bs-toggle="modal" data-bs-target="#supModal"><i class="fas fa-plus me-1"></i>Add Supplier</button>
</div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <p class="small mb-1"><i class="fas fa-phone me-1"></i><?= \escape($s->phone ?? '') ?></p>
                    <p class="small mb-0"><i class="fas fa-envelope me-1"></i><?= \escape($s->email ?? '') ?></p>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
