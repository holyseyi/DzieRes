...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-gold" data-bs-toggle="modal" data-bs-target="#promoModal"><i class="fas fa-plus me-1"></i>Add Promotion</button>
</div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="mt-2"><button class="btn btn-sm btn-outline-danger promo-del" data-id="<?= $p->id ?>"><i class="fas fa-trash"></i> Delete</button></div>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
