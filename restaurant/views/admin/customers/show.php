...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div><a href="<?= \baseUrl('admin/customers') ?>" class="text-muted small"><i class="fas fa-arrow-left me-1"></i>Back</a><h4 class="mb-0 mt-1"><?= \escape($customer->firstname . ' ' . $customer->lastname) ?></h4></div>
</div>
