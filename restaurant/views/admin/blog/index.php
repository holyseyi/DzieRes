...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= \baseUrl('admin/blog/create') ?>" class="btn btn-gold"><i class="fas fa-plus me-1"></i>New Post</a>
</div>
                ...
                <tbody>
                    <?php foreach ($posts as $p): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= \baseUrl('admin/blog/' . $p->id . '/edit') ?>" class="btn btn-sm btn-outline-secondary"><i class="fas fa-edit"></i></a>
                                <button class="btn btn-sm btn-outline-danger blog-del" data-id="<?= $p->id ?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
