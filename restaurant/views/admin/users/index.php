...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= \baseUrl('admin/users/create') ?>" class="btn btn-gold"><i class="fas fa-plus me-1"></i>Add User</a>
</div>
                ...
                <tbody>
                    <?php foreach ($users as $u): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= \baseUrl('admin/users/' . $u->id . '/edit') ?>" class="btn btn-sm btn-outline-secondary"><i class="fas fa-edit"></i></a>
                                <button class="btn btn-sm btn-outline-danger user-del" data-id="<?= $u->id ?>"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
