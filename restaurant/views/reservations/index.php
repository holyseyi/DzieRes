            ...
            <div class="col-lg-4">
                <div class="glass-card p-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="mb-3"><i class="fas fa-clock text-gold me-2"></i><?= \escape(\getSetting('opening_hours', 'Open Daily 7:00 AM - 11:00 PM')) ?></li>
                        <li class="mb-3"><i class="fas fa-phone text-gold me-2"></i><?= \escape(\getSetting('restaurant_phone', '+233 50 000 0000')) ?></li>
                        <li class="mb-3"><i class="fas fa-map-marker-alt text-gold me-2"></i><?= \escape(\getSetting('restaurant_address', '123 Independence Avenue, Accra')) ?></li>
                        <li><i class="fas fa-info-circle text-gold me-2"></i>Confirmation sent by email</li>
                    </ul>
                </div>
            </div>
        </div>
