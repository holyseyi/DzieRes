                    ...
                    <div class="col-md-6" data-aos="fade-up">
                        <div class="job-card glass-card p-4 h-100">
                            ...
                            <div class="text-muted small mb-2">
                                <?php if ($job->department): ?><i class="fas fa-building me-1"></i><?= \escape($job->department) ?> · <?php endif; ?>
                                <?php if ($job->location): ?><i class="fas fa-map-marker-alt me-1"></i><?= \escape($job->location) ?><?php endif; ?>
                            </div>
                            <p class="small"><?= \truncate($job->description ?? '', 120) ?></p>
                            <?php if ($job->salary_range): ?><p class="small text-gold fw-bold mb-3"><i class="fas fa-money-bill-wave me-1"></i><?= \escape($job->salary_range) ?></p><?php endif; ?>
