    ...
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-7">
                ...
                <div class="mb-3">
                    <span class="badge bg-light text-dark me-2"><i class="far fa-calendar me-1"></i><?= \formatDate($event->event_date) ?></span>
                    <?php if ($event->event_time): ?><span class="badge bg-light text-dark me-2"><i class="far fa-clock me-1"></i><?= \formatTime($event->event_time) ?></span><?php endif; ?>
                    <?php if ($event->location): ?><span class="badge bg-light text-dark"><i class="fas fa-map-marker-alt me-1"></i><?= \escape($event->location) ?></span><?php endif; ?>
                </div>
