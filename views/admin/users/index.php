...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= \baseUrl('admin/users/create') ?>" class="btn btn-gold"><?= \icon('plus', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Add User</a>
</div>
                ...
                <tbody>
                    <?php foreach ($users as $u): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= \baseUrl('admin/users/' . $u->id . '/edit') ?>" class="btn btn-sm btn-outline-secondary"><?= \icon('edit', []) ?></a>
                                <button class="btn btn-sm btn-outline-danger user-del" data-id="<?= $u->id ?>"><?= \icon('trash', []) ?></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
