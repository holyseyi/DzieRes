...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-gold" data-bs-toggle="modal" data-bs-target="#couponModal"><?= \icon('plus', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Add Coupon</button>
</div>
                ...
                <tbody>
                    <?php foreach ($coupons as $c): ?>
                        <tr>
                            ...
                            <td><button class="btn btn-sm btn-outline-danger coupon-del" data-id="<?= $c->id ?>"><?= \icon('trash', []) ?></button></td>
                        </tr>
                    <?php endforeach; ?>
