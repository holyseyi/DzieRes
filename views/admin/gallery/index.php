...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-gold" data-bs-toggle="modal" data-bs-target="#galleryModal"><?= \icon('upload', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Upload Image</button>
</div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        ...
                        <button class="btn btn-sm btn-outline-danger gallery-del" data-id="<?= $img->id ?>"><?= \icon('trash', []) ?></button>
                    </div>
                </div>
            </div>
        </div>
