...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-gold" data-bs-toggle="modal" data-bs-target="#ingModal"><?= \icon('plus', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Add Ingredient</button>
</div>

<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-white"><h6 class="mb-0"><?= \icon('plus-circle', ['style' => 'width:1.1em;height:1.1em;margin-right:0.5rem;vertical-align:-0.15em;', 'class' => 'text-gold']) ?>Add Stock / Purchase</h6></div>
    <div class="card-body">
