...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= \baseUrl('admin/employees/create') ?>" class="btn btn-gold"><?= \icon('plus', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Add Employee</a>
</div>
