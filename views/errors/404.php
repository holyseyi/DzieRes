...
<body>
    <div class="error-container">
        ...
        <div class="d-flex gap-3 justify-content-center">
            <a href="<?= \baseUrl() ?>" class="btn-gold"><?= \icon('home', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>Go Home</a>
            <a href="<?= \baseUrl('menu') ?>" class="btn-gold" style="background: transparent; border: 2px solid #001a4a; -webkit-text-fill-color: #001a4a;"><?= \icon('utensils', ['style' => 'width:0.9em;height:0.9em;margin-right:0.35rem;vertical-align:-0.15em;']) ?>View Menu</a>
        </div>
    </div>
</body>
</html>